---
title: "R Markdown Modeling Template - German Credit Dataset"
...
knitr::opts_knit$set(root.dir = "/Users/indralukastjahaja/OneDrive/09 Shared Folder/Data Science di Industri Keuangan")
# /Users/indralukastjahaja/OneDrive/09 Shared Folder/Data Science di Industri Keuangan
# D:/Dropbox/IYKRA - Capstone Project/BCA/3. R Documentation
```
...
### 0. Preparation
```{r preparation}
setwd("/Users/indralukastjahaja/OneDrive/09 Shared Folder/Data Science di Industri Keuangan")
# /Users/indralukastjahaja/OneDrive/09 Shared Folder/Data Science di Industri Keuangan
# D:/Dropbox/IYKRA - Capstone Project/BCA/3. R Documentation
```
...
df_credit <- read_excel("german_credit_easy.xls")
...
# performance
train_perf = perf_eva(trainResult1, train_pred, title = "train")
test_perf = perf_eva(testResult1, test_pred, title = "test")
# score ------
